...
<div class="wrap">
  ...
  <div class="frame">
    <b>Generated preview
      <span class="modes">
        <button class="chip" data-pmode="" aria-pressed="true">Both</button>
    ...
    <iframe id="pv" src="preview.html?chrome=0" title="${s.system} preview" loading="lazy"></iframe>
  </div>
...
<script>
  ...
  for (const btn of document.querySelectorAll('[data-pmode]')) {
    btn.addEventListener('click', () => {
      ...
      document.getElementById('pv').src = 'preview.html?chrome=0' + (m ? '&mode=' + m : '');
