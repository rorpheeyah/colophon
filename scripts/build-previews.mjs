...
.avatars.lap{gap:0;
  --_seam:linear-gradient(90deg,currentColor 15px,transparent 15px 17px,currentColor 17px)}
.avatars.lap span{margin-left:-9px}
.avatars.lap span:first-child{margin-left:0}
.avatars.lap span:not(:last-child){
  /* the label moves into the part that stays visible; a stacked avatar
     normally carries a photo, where the crop does not matter */
  justify-items:start;padding-left:4px;
